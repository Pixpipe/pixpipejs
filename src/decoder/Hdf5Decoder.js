...
*/
class Hdf5Decoder extends Filter{

  constructor( abuf, debug = false){
    super();
  ...
  */
  getU16() {
    var v = this._dv.getUint16(this._dv_offset, little_endian);
    this._dv_offset += 2;
    return v;
  }
  ...
  */
  getU32() {
    var v = this._dv.getUint32(this._dv_offset, little_endian);
    this._dv_offset += 4;
    return v;
  }
  ...
  */
  getU64() {
    var v = this._dv.getUint64(this._dv_offset, little_endian);
    this._dv_offset += 8;
    return v;
  }
  ...
  */
  getF32() {
    var v = this._dv.getFloat32(this._dv_offset, little_endian);
    this._dv_offset += 4;
    return v;
  }
  ...
  */
  getF64() {
    var v = this._dv.getFloat64(this._dv_offset, little_endian);
    this._dv_offset += 8;
    return v;
  }
  ...
  */
  getOffset(offsz) {
    ...
    if (offsz === 4) {
      v = this._dv.getUint32(this._dv_offset, little_endian);
    } else if (offsz === 8) {
      v = this._dv.getUint64(this._dv_offset, little_endian);
    } else {
  ...
  */
  getUXX(n) {
    ...
    case 1:
      ...
      break;
    case 2:
      v = this._dv.getUint16(this._dv_offset, little_endian);
      break;
    case 4:
      v = this._dv.getUint32(this._dv_offset, little_endian);
      break;
  ...
  this._dv.getUint64 = function (off, little_endian) {
    var l4 = this._dv.getUint32(off + 0, little_endian);
    var u4 = this._dv.getUint32(off + 4, little_endian);
    if (little_endian) {
      return (u4 << 32) + l4;
    } else {
      return (l4 << 32) + u4;
